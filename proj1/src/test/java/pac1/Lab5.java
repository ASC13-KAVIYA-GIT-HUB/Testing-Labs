...
public class Lab5 {
	...
	public static void main(String[] args) {
		...
		//PART 2
		//STEP 1:
		driver.findElement(By.xpath("//input[@placeholder='First Name']")).sendKeys("KAVIYA");
		//STEP 2:
		driver.findElement(By.xpath("/html/body/div[2]/div/div/form/div/div/input[2]")).click();
		//STEP 4:
		driver.findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("H R");
		//STEP:5
		driver.findElement(By.xpath("/html/body/div[2]/div/div/form/div/div/input[2]")).click();
		//Step 7:
		driver.findElement(By.xpath("//input[@placeholder='E-Mail']")).sendKeys("Kaviya28@gmail.com");
		//STEP 8:
		driver.findElement(By.xpath("//input[@placeholder='Telephone']")).sendKeys("1234567890");
		...
		//PART 4(PASSWORD)
		//STEP 1:
		driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("kaviya@123");
		//STEP 2:
		driver.findElement(By.xpath("//input[@placeholder='Password Confirm']")).sendKeys("kaviya@123");
